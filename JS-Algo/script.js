...
// function  convertMyAgeToSeconds(age){
//   return age * 12 * 30 * 24 * 60 * 60;
// }
// console.log(convertMyAgeToSeconds(age));

///////////////////////////////////////////////

// let movies = ['batman', 'notebook', 'rambo', 'bambi']

// function getFirstItem(someItem){
//   return movies[0]
// }
...
//CONDITIONALS
//Tell me the rating of a movie.

function badOrGoodMovie(movie_rating) {
  if (movie_rating >= 7) {
    return console.log("This movies was rated Good");
  } else {
    return console.log("this movie is rated negative");
  }
}
...
// console.log(isEmptyString('this should be false'))
...
//////// OPTION another faster method without///

let sortThisArray = [33, 22, 4, 55, 33];

sortThisArray.sort(function (a, b) {
  return a - b;
});
